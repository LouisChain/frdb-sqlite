...
namespace N_tier
{
    public class QueryExcutetionBLL
    {
        ...
        private List<FzAttributeBLL> _selectedAttributes = new List<FzAttributeBLL>();
        private List<FzRelationBLL> _selectedRelations = new List<FzRelationBLL>();
        List<int> _index = new List<int>();

        private String _queryText;
        private List<FzRelationBLL> _relationSet;
        ...
        public List<FzRelationBLL> RelationSet
        {
        ...
        public QueryExcutetionBLL(String queryText, List<FzRelationBLL> sets)
        {
        ...
        #region 4. Publics
        public FzRelationBLL ExecuteQuery()
        {
            FzRelationBLL result = new FzRelationBLL();
            try
            {
                ...
                if (this._queryText.Contains("where"))
                {
                    ...
                    foreach (FzTupleBLL tuple in this._selectedRelations[0].Tuples)
                    {
        ...
        private void GetSectedRelation()
        {
            try
            {
                ...
                {
                    foreach (FzRelationBLL item in RelationSet)
                    {
        ...
        private void GetSelectedAttr()
        {
            try
            {
                if (this._selectedAttributeTexts != null)
                {
                    ...
                    {
                        int i = 0;
                        foreach (FzAttributeBLL attr in this._selectedRelations[0].Scheme.Attributes)
                        {
        ...
        private FzTupleBLL GetSelectedAttributes(FzTupleBLL resultTuple)
        {
            FzTupleBLL r = new FzTupleBLL();
        ...
        private void AddToList(List<String> result, String exps, int i, String logic)
        {
            ...
            foreach (string item in Split(exp))
            {
