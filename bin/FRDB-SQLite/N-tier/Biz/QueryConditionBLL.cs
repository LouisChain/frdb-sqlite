...
namespace N_tier
{
    public class QueryConditionBLL
    {
        ...
        private List<FzAttributeBLL> _attributes = new List<FzAttributeBLL>();
        private Double _uRelation;
        private List<String> _memberships;

        private FzTupleBLL _resultTuple;
        private List<FzRelationBLL> _selectedRelations;
        private List<Item> _itemConditions;
        private String _errorMessage;
        #endregion

        #region 2. Properties
        public FzTupleBLL ResultTuple
        {
            get { return _resultTuple; }
            set
            {
                FzTupleBLL newTuple = new FzTupleBLL(value);
                this._resultTuple = newTuple;
            }
        }

        public List<FzRelationBLL> SelectedRelations
        {
        ...
        public QueryConditionBLL(List<Item> items, List<FzRelationBLL> sets)
        {
            //this._resultTuple = new FzTupleBLL();
        ...
        /// 
        /// </summary>
        public Boolean Satisfy(List<Item> list, FzTupleBLL tuple)
        {
            this._resultTuple = new FzTupleBLL() { ValuesOnPerRow = tuple.ValuesOnPerRow };//select * from rpatient where age <> "old"
        ...
        /// </summary>
        private Boolean SatisfyItem(List<String> itemCondition, FzTupleBLL tuple, int i)
        {
